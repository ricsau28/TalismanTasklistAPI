...
class Task():
    ...
    def __init__(task_name, date_added, modification_date, user_id = None, local_user_id = None, local_task_id = None, due_date = None, 
...
class User():
    ...
    def __init__(self, name, email=None, password=None, role=None):
        self.name = name
        self.email = email
