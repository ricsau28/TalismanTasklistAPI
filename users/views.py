...
@users_blueprint.route('/api/v1/users/hello')
def hello():
    return "Hello, world!"   
...
def get_user_id():
    ...
    """=== TEST ===
    user = User('pretty4423')
    user.email = 'pretty44@aol.com'
    user.password = 'password2345'
    """    

    user_id, db_exception = db.getUserID(user)

    if(db_exception is None and user_id):    
        msg = "{}".format("User id retrieved")
    else:
        msg = "Error code: {}, Details: {}".format(-1, db_exception)
